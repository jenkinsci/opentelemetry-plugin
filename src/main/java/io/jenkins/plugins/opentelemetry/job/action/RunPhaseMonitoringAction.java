 ...
 * @see JenkinsAttributes#JENKINS_JOB_SPAN_PHASE_START_NAME
 * @see JenkinsAttributes#JENKINS_JOB_SPAN_PHASE_RUN_NAME
 * @see JenkinsAttributes#JENKINS_JOB_SPAN_PHASE_FINALIZE_NAME
 */
