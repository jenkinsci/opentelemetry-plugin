...
public class JenkinsResourceProvider implements ResourceProvider {
    ...
    public Resource createResource(ConfigProperties config) {
        ...
        resourceBuilder.put(ServiceAttributes.SERVICE_NAME, JenkinsOtelSemanticAttributes.JENKINS);
        resourceBuilder.put(ServiceIncubatingAttributes.SERVICE_NAMESPACE, JenkinsOtelSemanticAttributes.JENKINS);
        ...
        resourceBuilder.put(ServiceAttributes.SERVICE_VERSION, jenkinsVersion);
        ...
        resourceBuilder.put(ServiceIncubatingAttributes.SERVICE_INSTANCE_ID, config.getString(ServiceIncubatingAttributes.SERVICE_INSTANCE_ID.getKey()));
