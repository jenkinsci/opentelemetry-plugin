...
public class JenkinsOtelPluginMBPIntegrationTest extends BaseIntegrationTest {
    ...
    public void testMultibranchPipelineStep() throws Exception {
        ...
        MatcherAssert.assertThat(attributes.get(JenkinsOtelSemanticAttributes.CI_PIPELINE_MULTIBRANCH_TYPE), CoreMatchers.is(OtelConstantUtils.BRANCH));
        MatcherAssert.assertThat(attributes.get(JenkinsOtelSemanticAttributes.CI_PIPELINE_TYPE), CoreMatchers.is(OtelConstantUtils.MULTIBRANCH));
