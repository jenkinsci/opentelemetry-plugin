...
public class JenkinsOtelPluginMBPIntegrationTest extends BaseIntegrationTest {
    ...
    public void testMultibranchPipelineStep() throws Exception {
        ...
        checkChainOfSpans(spans, "Stage: Declarative: Checkout SCM", JenkinsAttributes.AGENT_UI, "Phase: Run");
        ...
        MatcherAssert.assertThat(attributes.get(JenkinsAttributes.CI_PIPELINE_MULTIBRANCH_TYPE), CoreMatchers.is(OtelUtils.BRANCH));
        MatcherAssert.assertThat(attributes.get(JenkinsAttributes.CI_PIPELINE_TYPE), CoreMatchers.is(OtelUtils.MULTIBRANCH));
        MatcherAssert.assertThat(attributes.get(JenkinsAttributes.CI_PIPELINE_RUN_DESCRIPTION), CoreMatchers.is("Bar"));
        MatcherAssert.assertThat(attributes.get(JenkinsAttributes.CI_PIPELINE_RUN_CAUSE), CoreMatchers.is(List.of("BranchIndexingCause")));
