...
public class WithSpanAttributesStepTest extends BaseIntegrationTest {
    ...
    public void testSimplePipelineWithWithSpanAttributesStepMix() throws Exception {
        ...
        checkChainOfSpans(spans, "release-script-1", "Stage: build", JenkinsAttributes.AGENT_UI, "Phase: Run", rootSpanName);
        checkChainOfSpans(spans, "release-script-2", "Stage: build", JenkinsAttributes.AGENT_UI, "Phase: Run", rootSpanName);
        checkChainOfSpans(spans, "test-script", "Stage: test", JenkinsAttributes.AGENT_UI, "Phase: Run", rootSpanName);
    ...
    public void testSimplePipelineWithWithSpanAttributesStepOverride() throws Exception {
        ...
        checkChainOfSpans(spans, "release-script-1", "Stage: build", JenkinsAttributes.AGENT_UI, "Phase: Run", rootSpanName);
        checkChainOfSpans(spans, "release-script-2", "Stage: build", JenkinsAttributes.AGENT_UI, "Phase: Run", rootSpanName);
        checkChainOfSpans(spans, "test-script-1", "Stage: test", JenkinsAttributes.AGENT_UI, "Phase: Run", rootSpanName);
        checkChainOfSpans(spans, "test-script-2", "Stage: test", JenkinsAttributes.AGENT_UI, "Phase: Run", rootSpanName);
        checkChainOfSpans(spans, "test-script-3", "Stage: test", JenkinsAttributes.AGENT_UI, "Phase: Run", rootSpanName);
        checkChainOfSpans(spans, "Phase: Finalise", rootSpanName);
    ...
    public void testSimplePipelineWithWithSpanAttributesStepBlock() throws Exception {
        ...
        checkChainOfSpans(spans, "Phase: Start", rootSpanName);
        checkChainOfSpans(spans, JenkinsAttributes.AGENT_ALLOCATION_UI, JenkinsAttributes.AGENT_UI, "Phase: Run", rootSpanName);
        checkChainOfSpans(spans, "Stage: build", JenkinsAttributes.AGENT_UI, "Phase: Run", rootSpanName);
