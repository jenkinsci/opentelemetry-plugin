...
//            "       setSpanAttribute(key: 'pipeline.importance', value: 'critical', target: 'PIPELINE_ROOT_SPAN'/*, setOn: 'TARGET_AND_CHILDREN'*/)\n" +
//            "       setSpanAttribute(key: 'stage.type', value: 'build-java-maven', target: 'CURRENT_SPAN'/*, setOn: 'TARGET_ONLY'*/)\n" +
//            "       setSpanAttribute(key: 'build.tool', value: 'maven'/*, setOn: 'TARGET_AND_CHILDREN'*/)\n" +
